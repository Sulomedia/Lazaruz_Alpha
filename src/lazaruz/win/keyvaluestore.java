...
public class keyvaluestore extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4j.objects.FxBA("lazaruz.win", "lazaruz.win.keyvaluestore", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", lazaruz.win.keyvaluestore.class).invoke(this, new Object[] {null});
        else
